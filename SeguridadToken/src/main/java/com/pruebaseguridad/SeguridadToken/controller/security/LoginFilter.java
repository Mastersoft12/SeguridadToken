package com.pruebaseguridad.SeguridadToken.controller.security;
...
import com.pruebaseguridad.SeguridadToken.User;
...
public class LoginFilter extends AbstractAuthenticationProcessingFilter {
	...
	public Authentication attemptAuthentication(HttpServletRequest req, HttpServletResponse res)
		...
		// Asumimos que el body tendrÃ¡ el siguiente JSON {"username":"ask",
		// "password":"123"}
		// Realizamos un mapeo a nuestra clase User para tener ahi los datos
		User user = new ObjectMapper().readValue(body, User.class);

		// Finalmente autenticamos
		// Spring compararÃ¡ el user/password recibidos
